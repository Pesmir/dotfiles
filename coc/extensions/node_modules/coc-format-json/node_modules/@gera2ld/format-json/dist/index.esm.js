/*! @gera2ld/format-json v0.2.1 | MIT License */
...
function renderObject(data, options, path = []) {
  ...
  const rendered = Object.keys(data).map(key => {
    ...
    return [keyItem, render(data[key], options, subpath)];
...
export { ItemTypes, format, render };
